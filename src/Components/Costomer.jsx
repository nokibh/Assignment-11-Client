const Costomer = () => {
  return (
    <div>
      <div>
        <h1 className="text-center  mt-4 mb-2 text-2xl font-bold text-black">
          Guest Review
        </h1>
        <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2 border gap-4 ">
          ...
          <div>
            <div className="flex flex-col max-w-xl p-8 mt-20 shadow-lg rounded-xl lg:p-12 dark:bg-gray-50 dark:text-gray-800">
              <div className="flex flex-col w-full">
                <h2 className="text-3xl font-semibold text-center">
                  Customer reviews
                </h2>
